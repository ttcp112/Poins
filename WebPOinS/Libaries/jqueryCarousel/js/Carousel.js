    ...
    $.fn.carousel = function (param) {
        ...
        $(this).each(function(index, target) {
            ...
            if (typeof param === 'object' && param !== null) {
                ...
                //by ngoc han
                $target.find('.left_md').off('click').on('click', (function ($target) {
                    return function () {
                        scroll($target, 'left');
                    }
                })($target));
                $target.find('.right_md').off('click').on('click', (function ($target) {
                    return function () {
                        scroll($target, 'right');
                    }
                })($target));
                //by ngoc han
                $target.find('.left_sm').off('click').on('click', (function ($target) {
                    return function () {
                        scroll($target, 'left');
                    }
                })($target));
                $target.find('.right_sm').off('click').on('click', (function ($target) {
                    return function () {
                        scroll($target, 'right');
                    }
                })($target));
